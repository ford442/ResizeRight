...
def resize(input, scale_factors=None, out_shape=None,interp_method=interp_methods.cubic, support_sz=6,antialiasing=False, by_convs=False, scale_tolerance=None,max_numerator=10, pad_mode='constant'):
